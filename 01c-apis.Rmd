...
```{r}
counts <- nyt_years_count(q="inequality", yearinit=1950, yearend=2012)
plot(1950:2012, counts, type="l", main="Mentions of inequality on the NYT, by year",
...
```{r}
counts <- nyt_dates_count(q="trump", init = as.Date("2014/01/01"), end = as.Date("2017/05/30"), by="month")
